...
<br>
<br>
<c:if test="${not empty mensagemTask}">
        					<div class="alert alert-warning" role="alert">
        						<h4>${mensagemTask}</h4>
        					</div>
        </c:if>
<form:form action="/task" modelAttribute="task" method="POST">
        <div class="col">
            <form:label for="exampleFormControlSelect1" path="issueType">Issue Type:</form:label>
            <form:select class="form-control" id="exampleFormControlSelect1" path="issueType" name="issueType" type="text">
        ...
        <div class="col">
                ...
                <form:input type="text" name="title" path="title" class="form-control" id="exampleFormControlInput1"/>
        </div>
    <div class="form-group">
        <form:label path="description" for="exampleFormControlTextarea1" class="form-label">Description:</form:label>
        <form:textarea type="text" name="description" path="description" class="form-control" id="exampleFormControlTextarea1" rows="3"></form:textarea>
    </div>
    <div class="form-group"><br>
        <form:button type="submit" class="btn btn-primary">ADICIONAR NA LISTA</form:button>
    </div>
</form:form>
</div>
